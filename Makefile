...
MODULES= modules/*.o
LIBS= -lpthread -pthread -lrt -lncurses   
...
aldl-wsl: main.c serio-dummy.o config.h aldl-io.h aldl-types.h modules_ $(OBJS)
	gcc $(CFLAGS) $(LIBS) main.c -o aldl-dummy $(OBJS) $(MODULES) serio-dummy.o -lncurses
